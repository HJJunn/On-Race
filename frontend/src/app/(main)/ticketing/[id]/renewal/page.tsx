      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <div className="text-gray-500">마라톤</div>

            <div className="flex flex-rows items-center justify-between mb-8">
            ...
            <div className="space-y-3 mb-2 text-sm sm:text-base">
              ...
              <div className="flex">
                ...
                <div className="flex-1">
                  <p>
                    본 상품은 일괄배송 상품으로 2026년 4월 1일부터 순차
                    배송됩니다.
                  </p>
              ...
              {activeTab === 'product' && (
                <div className="space-y-4">
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 border-1 border-gray-200 text-sm md:text-base">
                      {/* 행 1-1 */}
                      ...
                      <table className="w-full text-sm md:text-base border-collapse">
                        <tbody>
                          <tr className="border-b border-gray-300">
                            <th className="w-1/4 py-4 px-4 bg-gray-100 text-left font-semibold text-gray-600">
                              참가비 안내
                            </th>
                          ...
                          <tr className="border-b border-gray-300">
                            <th className="py-4 px-4 bg-gray-100 text-left font-semibold text-gray-600">
                              패키지 정보
                            </th>
